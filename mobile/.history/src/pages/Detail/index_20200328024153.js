...
export default function Detail() {
    ...
    const message = `Olá ${incident.name}, estou entrar em contacto pois gostaria de ajudar no caso "{{{Cadelinha Atropelada ${incident.title}", com o valor de 120€`;
    ...
    function sendWhatsApp() {
        Linking.openURL(`whatsapp://send?phone=${incident.}&text=${message}`);
    }
